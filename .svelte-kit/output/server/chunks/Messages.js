import { c as create_ssr_component, b as subscribe, l as createEventDispatcher, p as getContext, a as add_attribute, f as escape, e as each, v as validate_component, o as onDestroy, w as null_to_empty } from "./ssr.js";
import { t as tick } from "./scheduler.js";
import { v4 } from "uuid";
import { B as tags, m as models, p as WEBUI_API_BASE_URL, o as mobile, d as chatId, a as settings, c as config, T as TTSWorker, u as user, t as temporaryChatEnabled, b as currentChatPage, z as chats } from "./index3.js";
import { a as toast } from "./Toaster.svelte_svelte_type_style_lang.js";
import { u as updateChatById, b as getChatList } from "./index8.js";
...
const ResponseMessage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(ConfirmDialog, "DeleteConfirmDialog").$$render(
      ...
      $$result,
      {
        src: model?.info?.meta?.profile_image_url ?? ($i18n.language === "dg-DG" ? `/doge.png` : `/static/favicon.png`),
        className: "size-8"
      },
      {},
      {}
