...
const Prompts = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-1bq1zi1_START -->${$$result.title = `<title> ${escape($i18n.t("Prompts"))} | ${escape($WEBUI_NAME)} </title>`, ""}<!-- HEAD_svelte-1bq1zi1_END -->`, ""} ${`<div class="w-full h-full flex justify-center items-center">${validate_component(Spinner, "Spinner").$$render($$result, {}, {}, {})}</div>`}`;
  } while (!$$settled);
  $$unsubscribe_i18n();
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Prompts, "Prompts").$$render($$result, {}, {}, {})}`;
});
export {
  Page as default
};
