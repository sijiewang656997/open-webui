import { n as noop, c as create_ssr_component, a as add_attribute, e as each, b as subscribe, d as add_styles, v as validate_component, f as escape, g as merge_ssr_styles, m as missing_component, h as compute_rest_props, o as onDestroy, i as spread, j as escape_attribute_value, k as escape_object, s as setContext } from "../../chunks/ssr.js";
...
import { t as toastState, u as useEffect, c as cn } from "../../chunks/Toaster.svelte_svelte_type_style_lang.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_isApp = subscribe(isApp, (value) => value);
  ...
  $$unsubscribe_isApp();
  $$unsubscribe_theme();
  return `${$$result.head += `<!-- HEAD_svelte-1eeu451_START -->${$$result.title = `<title>${escape($WEBUI_NAME)}</title>`, ""}<link crossorigin="anonymous" rel="icon" href="${escape(WEBUI_BASE_URL, true) + "/static/favicon.png"}"><!-- HEAD_svelte-1eeu451_END -->`, ""} ${``} ${validate_component(Toaster, "Toaster").$$render(
    $$result,
    {
