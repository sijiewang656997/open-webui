...
var On = ((e) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e, { get: (t, r) => (typeof __require < "u" ? __require : t)[r] }) : e)(function(e) {
...
var Ft = (e) => Wp(zn({}, "__esModule", { value: true }), e);
var fr;
var vt;
var $t;
var Lp;
...
var Ia = U(() => {
  "use strict";
  var _a2, _b;
  Sa = (Wn = import.meta.url, async function(e = {}) {
    var _a3;
    ...
    let c = (s) => async (...l) => {
      ...
      try {
        ...
        (_a4 = n.Jb) == null ? void 0 : _a4.flush();
        let w = h.errors;
        if (0 < w.length) {
...
`))[0] == "Error" && y.shift(), xi(y);
    ...
    (async function() {
      ...
      kt ?? (kt = n.locateFile ? n.locateFile ? n.locateFile("ort-wasm-simd-threaded.jsep.wasm", _) : _ + "ort-wasm-simd-threaded.jsep.wasm" : new URL("ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href);
      try {
  ...
  }), Fp = Sa, qp = (_b = (_a2 = globalThis.self) == null ? void 0 : _a2.name) == null ? void 0 : _b.startsWith("em-pthread");
  qp && Sa();
});
var Ea;
var Gn;
...
var _r = U(() => {
  "use strict";
  yr();
  Ea = typeof location > "u" ? void 0 : location.origin, Gn = import.meta.url > "file:" && import.meta.url < "file;", jp = () => {
    if (true) {
      if (Gn) {
        let e = URL;
        return new URL(new e("ort.bundle.min.mjs", import.meta.url).href, Ea).href;
      }
...
var ht = U(() => {
  ...
  Fn = false, Ar = false, Ba = false, Yp = () => {
    ...
    let o = e.wasmPaths, i = typeof o == "string" ? o : void 0, a = o == null ? void 0 : o.mjs, u = (a == null ? void 0 : a.href) ?? a, d = o == null ? void 0 : o.wasm, c = (d == null ? void 0 : d.href) ?? d, p = e.wasmBinary, [m, f] = await Oa(u, i, r > 1), b = false, g = [];
...
var Ma = U(() => {
  ...
  Da = (e) => {
    ...
    try {
      ...
      let i = 0;
      return (e == null ? void 0 : e.tag) !== void 0 && (i = Ne(e.tag, n)), r = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), r === 0 && pe("Can't create run options."), (e == null ? void 0 : e.extra) !== void 0 && Kt(e.extra, "", /* @__PURE__ */ new WeakSet(), (a, u) => {
  ...
  Yn = (e, t = true) => {
    ...
    async download(t) {
      ...
      if (this.activeUpload) {
        let r = ((_a2 = this.wrapper) == null ? void 0 : _a2.isInt64ToInt32Converted) ? Ha(this.activeUpload) : this.activeUpload;
        if (t) {
      ...
      return t ? this.wrapper.read((_b = this.wrapper) == null ? void 0 : _b.shouldConvertInt64toInt32, t) : this.wrapper.read((_c = this.wrapper) == null ? void 0 : _c.shouldConvertInt64toInt32);
    }
  }, Qn = class {
    constructor(t) {
      this.backend = t;
...
var Ka = U(() => {
  ...
  Xn = /* @__PURE__ */ new Map([[1, "float32"], [10, "float16"], [6, "int32"], [12, "uint32"], [7, "int64"], [13, "uint64"], [22, "int4"], [21, "uint4"], [3, "int8"], [2, "uint8"], [9, "uint8"]]), dm = (e, t) => {
    ...
    isInt64Supported(t) {
      var _a2;
      return !!((_a2 = this.mlContextBySessionId.get(t)) == null ? void 0 : _a2.opSupportLimits().input.dataTypes.includes("int64"));
    }
    flush() {
    }
  };
    ...
    let i = e.map((p) => p.length).map((p, m) => P(`input${m}`, t, p)), a = k.size(n), u = M("output", t, n.length), d = [...r.symbolToInfo.keys()].filter((p) => !r.rhs.symbolToIndices.has(p)), c = (p) => {
      ...
      r.symbolToInfo.forEach((E, I) => {
        ...
        if (r.rhs.symbolToIndices.has(I)) {
          let z = (_a2 = r.rhs.symbolToIndices.get(I)) == null ? void 0 : _a2[0];
...
var ec = U(() => {
  ...
  cg = (e, t) => {
    ...
    var _a2, _b;
    let n = e.name;
    return ((_a2 = e.shaderCache) == null ? void 0 : _a2.hint) && (n += "[" + e.shaderCache.hint + "]"), n += ":" + r + `:${cg(t, ((_b = e.shaderCache) == null ? void 0 : _b.inputDependencies) ?? new Array(t.length).fill("dims"))}`, n;
  }, Io = class {
    constructor(t) {
    ...
    flush() {
      ...
      this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), t = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(t, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, t, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && t.mapAsync(GPUMapMode.READ).then(() => {
        ...
        for (let o = 0; o < r.length / 2; o++) {
          ...
          if ((_a2 = this.env.webgpu.profiling) == null ? void 0 : _a2.ondata) this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: m.map(($) => ({ dims: $.dims, dataType: Ye($.dataType) })), outputsMetadata: f.map(($) => ({ dims: $.dims, dataType: Ye($.dataType) })), kernelId: a, kernelType: d, kernelName: c, programName: p, startTime: _, endTime: S });
          else {
            let $ = "";
            m.forEach((x, T) => {
...
var rc = U(() => {
  ...
  tr = class e {
    ...
    compute(t, r) {
      var _a2;
      let n = ((_a2 = r == null ? void 0 : r.inputs) == null ? void 0 : _a2.map((u) => typeof u == "number" ? this.inputs[u] : u)) ?? this.inputs, o = (r == null ? void 0 : r.outputs) ?? [], i = (u, d, c) => new tr(this.module, d, this.output(u, c), c), a = (u, d) => {
        let c = gt(u, d);
...
var Vn = U(() => {
  ...
  fg = (e, t) => {
    ...
    var _a2, _b;
    (_b = (_a2 = fe()).asyncInit) == null ? void 0 : _b.call(_a2);
    {
      let r = (rc(), Ft(tc)).init;
      if (t === "webgpu") {
    ...
    try {
      ...
      for (let T of (t == null ? void 0 : t.executionProviders) ?? []) if ((typeof T == "string" ? T : T.name) === "webnn") {
        if (o.shouldTransferToMLTensor = false, typeof T != "string") {
          let I = T, z = I == null ? void 0 : I.context, O = I == null ? void 0 : I.gpuDevice, D = I == null ? void 0 : I.deviceType, L = I == null ? void 0 : I.powerPreference;
      ...
      i = await o._OrtCreateSession(r, n, a), (_a2 = o.webgpuOnCreateSession) == null ? void 0 : _a2.call(o, i), i === 0 && pe("Can't create a session."), (_b = o.jsepOnCreateSession) == null ? void 0 : _b.call(o), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = true);
      let [m, f] = hg(i), b = !!(t == null ? void 0 : t.enableGraphCapture), g = [], _ = [], S = [], $ = [], v = [];
      for (let T = 0; T < m; T++) {
        let [E, I, z] = nc(i, T);
      ...
      for (let T = 0; T < f; T++) {
        ...
        _.push(O), $.push(I === 0 ? { name: O, isTensor: false } : { name: O, isTensor: true, type: Ye(I), shape: z });
        {
          ...
          let D = typeof (t == null ? void 0 : t.preferredOutputLocation) == "string" ? t.preferredOutputLocation : ((_c = t == null ? void 0 : t.preferredOutputLocation) == null ? void 0 : _c[O]) ?? "cpu";
      ...
      o._free(r), a !== 0 && o._OrtReleaseSessionOptions(a) !== 0 && pe("Can't release session options."), d.forEach((m) => o._free(m)), (_d2 = o.unmountExternalData) == null ? void 0 : _d2.call(o);
    }
  }, Sr = (e) => {
    var _a2, _b, _c;
    let t = fe(), r = At.get(e);
    ...
    try {
      ...
      if (f && !g) {
        ...
        for (let H = 0; H < S; H++) {
          let j = n[H];
          ((_a2 = o[H]) == null ? void 0 : _a2[3]) ? a._OrtBindOutput(W, m[j], T[H], 0) !== 0 && pe(`Can't bind pre-allocated output[${H}] for session=${e}.`) : a._OrtBindOutput(W, m[j], 0, we[j]) !== 0 && pe(`Can't bind output[${H}] to ${Z[H]} for session=${e}.`);
        }
      ...
      for (let W = 0; W < S; W++) {
        ...
        try {
          ...
          te = Ye(ye);
          let ze = f == null ? void 0 : f.outputPreferredLocations[n[W]];
          if (te === "string") {
          ...
          a.stackRestore(we), te === "string" && X && a._free(X), j || a._OrtReleaseTensor(Z), (_d2 = a.webnnOnRunEnd) == null ? void 0 : _d2.call(a, c);
        }
      }
  ...
  Et = () => !!ge.wasm.proxy && typeof document < "u", rr = false, sn = false, un = false, ko = /* @__PURE__ */ new Map(), Vt = (e, t) => {
    ...
    if (!sn) {
      ...
      if (rr = true, Et()) return new Promise((e, t) => {
        Le == null ? void 0 : Le.terminate(), za().then(([r, n]) => {
          try {
            Le = n, Le.onerror = (i) => t(i), Le.onmessage = bg, Eo = [e, t];
            let o = { type: "init-wasm", in: ge };
            !o.in.wasm.wasmPaths && (r || Gn) && (o.in.wasm.wasmPaths = { wasm: new URL("ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href }), Le.postMessage(o), an = r;
          } catch (o) {
            t(o);
          }
        }, t);
...
onnxruntime-web/dist/ort.bundle.min.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-CIWHGHXW.js.map
