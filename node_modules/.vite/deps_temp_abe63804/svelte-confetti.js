...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", "confetti-holder svelte-15ksp55");
      toggle_class(
        div,
        "rounded",
        /*rounded*/
      ...
      add_location(div, file, 40, 2, 1147);
    },
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty & /*disableForReducedMotion*/
      8192) {
        toggle_class(
          div,
          "reduced-motion",
...
function create_each_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", "confetti svelte-15ksp55");
      set_style(
        div,
        "--fall-distance",
        /*fallDistance*/
      ...
      ctx[12]);
      add_location(div, file, 42, 6, 1322);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
    },
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("colorRange" in $$props2) $$invalidate(16, colorRange = $$props2.colorRange);
    if ("colorArray" in $$props2) $$invalidate(17, colorArray = $$props2.colorArray);
    ...
    if ("destroyOnComplete" in $$props2) $$invalidate(18, destroyOnComplete = $$props2.destroyOnComplete);
    if ("disableForReducedMotion" in $$props2) $$invalidate(13, disableForReducedMotion = $$props2.disableForReducedMotion);
  };
  $$self.$capture_state = () => ({
    onMount,
    size,
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("destroyOnComplete" in $$props2) $$invalidate(18, destroyOnComplete = $$props2.destroyOnComplete);
    if ("disableForReducedMotion" in $$props2) $$invalidate(13, disableForReducedMotion = $$props2.disableForReducedMotion);
    if ("complete" in $$props2) $$invalidate(14, complete = $$props2.complete);
  };
...
var Confetti = class extends SvelteComponentDev {
  ...
  set disableForReducedMotion(value) {
    throw new Error("<Confetti>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
};
