...
export declare const getInitialStore: ({ nodes, edges, width, height, fitView, nodeOrigin, nodeExtent }: {
    ...
    fitViewQueued: import("svelte/store").Writable<boolean>;
    fitViewOptions: import("svelte/store").Writable<FitViewOptions | undefined>;
    fitViewResolver: import("svelte/store").Writable<{
