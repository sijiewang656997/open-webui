...
import { type Viewport, type PanZoomInstance, type ConnectionLookup, type EdgeLookup, type NodeLookup, type ParentLookup, type NodeOrigin, type CoordinateExtent, withResolvers } from '@xyflow/system';
import type { DefaultEdgeOptions, DefaultNodeOptions, Edge, FitViewOptions, InternalNode, Node } from '../types';
...
export declare const createNodesStore: (nodes: Node[], nodeLookup: NodeLookup<InternalNode>, parentLookup: ParentLookup<InternalNode>, nodeOrigin: NodeOrigin | undefined, nodeExtent: CoordinateExtent | undefined, fitViewQueued: Writable<boolean>, fitViewOptions: Writable<FitViewOptions | undefined>, fitViewResolver: Writable<ReturnType<typeof withResolvers<boolean>> | null>, panZoom: Writable<PanZoomInstance | null>, width: Writable<number>, height: Writable<number>, minZoom: Writable<number>, maxZoom: Writable<number>) => {
