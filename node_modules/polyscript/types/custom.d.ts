...
export const customObserver: Map<any, any>;
export function handleCustomType(node: Element): Promise<void>;
...
export type CustomOptions = {
     ...
     */
    interpreter: 'pyodide' | 'micropython' | 'ruby-wasm-wasi' | 'wasmoon';
    /**
